<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/AdminSite.Master" WarningLevel="4"
    ValidateRequest="false" Inherits="System.Web.Mvc.ViewPage<Disappearwind.PortalSolution.PortalWeb.Models.PortalDocument>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <p>
            <label for="MenuId">
                Menu:</label>
            <%= Html.DropDownList("MenuId", ViewData[PortalSessionKey.SelectDocumentPortalMenu.ToString()] as SelectList, Model.MenuId)%>
        ...
        <p>
            <label for="Description">
                Description:</label>
            <%= Html.TextArea("Description", Model.Description, new { @height=800})%>
